...
自动化提示词生成技术正在改变提示词工程的实践方式。APE 框架通过"用模型优化模型输入"的理念，实现了候选生成、评估、选择的自动化闭环。元提示技术提供了灵活的模板化方法。OPRO 等迭代优化方法则通过反馈驱动持续改进。在实际应用中，建议结合自动化探索和人工专家判断，充分发挥两者的优势。

### 12.1.8 延伸阅读

- [Large Language Models Are Human-Level Prompt Engineers](https://arxiv.org/abs/2211.01910) - APE 原始论文
- [Large Language Models as Optimizers](https://arxiv.org/abs/2309.03409) - OPRO 论文
- [PromptBreeder: Self-Referential Self-Improvement](https://arxiv.org/abs/2309.16797) - 自我进化提示词
- [INSTRUCT-EVAL](https://arxiv.org/abs/2306.04757) - 指令跟随评估基准
