...
- [Anthropic Claude Documentation](https://docs.anthropic.com/en/docs) - 官方完整文档
- [Claude Prompt Engineering Guide](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering) - 提示词工程指南
- [Extended Thinking Guide](https://docs.anthropic.com/en/docs/build-with-claude/extended-thinking) - 扩展思考使用指南
- [Claude API Reference](https://docs.anthropic.com/en/api) - API 参考文档
