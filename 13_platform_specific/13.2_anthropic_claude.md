...
> **说明（核验日期：2026-06-09）：** 本节所涉及的模型特性及最佳实践基于 2026 年 6 月的官方文档编写。在实际应用中请参考 Anthropic 最新的官方文档。
...
| 模型 | 上下文 | 核心优势 | 适用场景 |
|------|-------|---------|----------|
| Claude Fable 5 | 1M | 能力最强的广泛发布模型（2026-06-09 GA，$10/$50，Adaptive Thinking 常开，128K 输出） | 最高难度推理、长程智能体任务 |
...
> 2026-06-09 同日发布的 Claude Mythos 5 仅面向 Project Glasswing 受邀客户提供，不对外公开发售。
