...
| 模型 | 上下文 | 核心优势 | 适用场景 |
|------|-------|---------|----------|
| Claude Fable 5 | 1M | 能力最强的广泛发布模型（2026-06-09 GA，$10/$50，Adaptive Thinking 常开，128K 输出）；2026-06-12 起访问暂停 | 发布规格快照；生产接入前核验可用性 |
...
> 2026-06-09 同日发布的 Claude Mythos 5 仅面向 Project Glasswing 受邀客户提供，不对外公开发售；Anthropic 于 2026-06-12 宣布暂停 Fable 5 与 Mythos 5 访问。
