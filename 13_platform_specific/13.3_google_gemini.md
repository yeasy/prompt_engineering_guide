...
> **上下文窗口详解**：Gemini 2.5 Pro / Flash / Flash-Lite 的官方模型页列出 1,048,576 输入 token 与 65,536 输出 token。对生产环境来说，通常优先选择稳定版 **Gemini 2.5 Pro / Flash**；`Gemini 3.1 Pro Preview` 更适合在可接受预览波动时做前沿评估。Google 官方模型页提示 Gemini 3 Pro Preview 已于 2026-03-09 关闭，应迁移到 Gemini 3.1 Pro Preview。
