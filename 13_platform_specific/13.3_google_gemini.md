...
| 模型 | 上下文窗口 | 核心特点 | 适用场景 |
|------|-----------|---------|----------|
| Gemini 3.1 Pro | 1M tokens | 最新旗舰、复杂推理与 agent 工作流 | 最复杂任务、跨应用分析 |
| Gemini 2.5 Pro | 1M tokens | 最强能力、多模态 | 复杂分析、长文档 |
| Gemini 2.5 Flash | 1M tokens | 低延迟、高性价比、具备推理能力 | 实时交互、批量处理 |
| Gemini 2.5 Flash-Lite | 1M tokens | 成本优化、极速 | 高并发场景 |
| Gemini 1.5 Pro | 1M tokens | 百万级上下文首创 | 超长文档处理 |
| Gemini Nano | 设备端 | 轻量级、离线运行 | 移动端本地应用 |

> **上下文窗口详解**：Gemini 1.5 Pro 首次将百万级上下文（1M tokens）带入主流 API，后续 Gemini 2.5 Pro、Gemini 3.1 Pro 和 2.5 Flash 系列继续提供 1M tokens 级别的长上下文能力。超长上下文非常适合整本书、多份长文档或长视频摘要类任务。
...
> **注意**：以下代码示例使用稳定版 `gemini-2.5-pro`。Gemini 3.1 Pro 已发布预览版（`gemini-3.1-pro-preview`），可按需替换。请始终参考 [Google 官方文档](https://ai.google.dev/gemini-api/docs/models)获取最新的可用模型列表。
...
- Gemini 1.5/3 Pro（1M tokens）：约 75 万字的中文文本、整部小说
- Gemini 2.5/3 Pro（1M tokens 级）：约 75 万字的中文文本、长篇技术资料、多份长文档联合分析，以及较长时长的视频/音频理解任务
