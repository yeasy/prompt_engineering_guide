...
> **说明（核验日期：2026-07-10）：** Google 模型页当前将 Gemini 3.5 Flash 标为 Stable，将 Gemini 3.1 Pro 标为 Preview。生产系统不要把 Preview、`latest` 别名、上下文窗口或价格写死在业务逻辑中。
...
| 模型 | 上下文窗口 | 核心特点 | 适用场景 |
|------|-----------|---------|----------|
| Gemini 3.5 Flash | 以官方模型页为准 | Stable、面向持续 agent 与代码任务 | 生产候选、需要稳定可用性的多模态工作流 |
