...
| **结构化输出** | JSON Schema / Function | Structured Outputs / System Prompt（注：Prefill 已在 4.6+ 停止支持，仅 4.5 及更早可用，详见 [13.2 节](13.2_anthropic_claude.md)） | JSON Schema | 语法约束 (Grammar) |
