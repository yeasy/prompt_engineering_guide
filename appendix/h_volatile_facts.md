...
| Anthropic | Claude Fable 5 / Mythos 5（2026-06-09 GA/受邀；曾于 2026-06-12 暂停访问，截至 2026-07-09 官方模型页已恢复 Fable 5 为 GA、Mythos 5 为受限可用）与 Claude 4.x、thinking、tool use、Claude Code 以官方文档为准。 | [Claude Models](https://platform.claude.com/docs/en/about-claude/models/overview), [Fable/Mythos access statement](https://www.anthropic.com/news/fable-mythos-access), [Claude Code Docs](https://code.claude.com/docs/) | 不预测未发布模型，不把 beta 当 GA；“最强/旗舰”须区分发布规格、当前可用性、Fable 5（全系）与 Opus 4.8（Opus 档）。 |
