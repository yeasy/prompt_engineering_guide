...
通过引导模型展示推理步骤来提升复杂任务表现的提示技术，简称CoT。
...
**RAG（检索增强生成）**  
Retrieval-Augmented Generation，结合信息检索和文本生成的技术架构。

**ReAct**  
Reasoning and Acting，将推理与行动交替进行的Agent框架。
